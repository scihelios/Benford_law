...
def distance(f,g):
	...
	f1=f+np.ones(9)
	print(f1,g1)
	return sum(max(float((f1[i]-g1[i])/g1[i]),float((g1[i]-f1[i])/f1[i]))**2 for i in range(0,8))
...
def clicked1():
	...
	# Import the tcl file
	window.tk.call("source", "C:/Users/ahmed/themes/Azure-ttk-theme-main/azure-dark.tcl")
...
# Create a style
stylee = ttk.Style(verify)

# Import the tcl file
verify.tk.call("source", "C:/Users/ahmed/themes/Azure-ttk-theme-main/azure-dark.tcl")

# Set the theme with the theme_use method
stylee.theme_use("azure-dark")
